        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-10 lg:gap-16">
          ...
          <div>
            ...
            <div className="space-y-5 mb-10">
              {[
                { icon: IconMapPin, label: 'Headquarters', value: '169, Evershine Mall, Chincholi Bunder Junction, Malad West, Mumbai - 400064', href: 'https://maps.google.com/?q=169+Evershine+Mall+Chincholi+Bunder+Junction+Malad+West+Mumbai+400064', external: true },
                { icon: IconMapPin, label: 'Hub', value: 'Address coming soon' },
