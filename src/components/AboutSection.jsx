      ...
      <div className={`${SECTION_CONTAINER} ${continuation ? CONTAINER_GAP : ''}`}>
        ...
        <motion.div
          ...
          {features.map(({ icon: Icon, title, desc }, i) => (
            <Fragment key={title}>
              {i > 0 && <div className="hidden xl:block border-l border-gray-300/60 dark:border-gray-500 shrink-0 self-stretch xl:mx-2"/>}
              {i > 0 && <div className="md:hidden border-t border-gray-300/60 dark:border-gray-500 w-full my-1"/>}
